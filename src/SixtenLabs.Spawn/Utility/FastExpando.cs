...
namespace SixtenLabs.Spawn.Utility
{
	...
	/// </summary>
	[SuppressMessage("Microsoft.Naming", "CA1710:IdentifiersShouldHaveCorrectSuffix"), SuppressMessage("Microsoft.StyleCop.CSharp.OrderingRules", "SA1201:ElementsMustAppearInTheCorrectOrder", Justification = "This is an interface imlpementation")]
	public sealed class FastExpando : DynamicObject, IDictionary<string, object>
	{
		...
		/// </summary>
		private IDictionary<string, object> data { get; } = new Dictionary<string, object>(StringComparer.OrdinalIgnoreCase);
	}
}
