...
{
	/// <summary>
	/// This is a copy Exactly of SyntaxKind from
	/// Assembly Microsoft.CodeAnalysis.CSharp, Version=1.2.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35
	/// We use this so that consuming assemblies do not need to bring in the reference to Rosyln to work.
	/// When real SyntaxKind is needed we will call this enum to SyntaxKind.
	/// </summary>
	public enum SyntaxKindDto : ushort
	{
		None = 0,
		List = 1,
		TildeToken = 8193,
